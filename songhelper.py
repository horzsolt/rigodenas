favourites = ("TALE_OF_US", "UMEK", "ANJUNA", "ISMA", "BUUREN", "DIGWEED","SAIZ", "PETE_TONG", "PETE.TONG", "DOORN", "GUY_J", "GUY.J", "NICK_WARREN", "NICK.WARREN", "SASHA", "MACEO_PLEX",
            ...
            "WESTBAM", "BERGHEAU", "BOOKA_SHADE", "BLIZZARD", "RANK1", "RANK_1", "KOLETZKI", "KALKBRENNER", "REX_MUNDI", "DASH_BERLIN", "ORJAN_NIELSEN",
            "GARETH_EMERY", "BLOMQVIST", "NADJALIND", "NADJA_LIND", "EXTRAWELT", "SCAVO", "KOLLEKTIV", "BERLIN", "DAHLBACK", "BENASSI", "VARIOUS",
            ...
            "EULBERG, HAZENDONK", "RILEY_REINHOLD", "_TOP", "CD_POOL", "TRANCE", "RESIDENT", "ADVISOR", "FABRIK", "WILLCOX", "TYDI", "ANTHOLOGY",
